...
public class ProjectService {
	...
	public ResponseEntity<?> deleteProject(String projectId, String userId, String sessionId) {
		...
		issueService.deleteProjectIssues(userId, projectId, sessionId);
		return ResponseEntity.ok().body("Project " + projectId + " removed!");
	}

	public ResponseEntity<?> addMemberToProject(String userId, String usernameToAdd, String projectId,
			String sessionId) {
	...
	public ResponseEntity<?> removeMemberFromProject(String userId, String usernameToRemove, String projectId,
			String sessionId, String userIdToRemove) {
		...
		User userToRemove = mongoOperations.findOne(new Query(Criteria.where("username").is(usernameToRemove)),
				User.class);
		...
		mongoOperations.save(project);
		issueService.removeEstimatedTimeFromProject(userId, projectId, sessionId, userIdToRemove);
		issueService.removeAssignedMemberFromProject(userId, projectId, sessionId, userIdToRemove);
